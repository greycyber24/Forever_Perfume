    ...
    <nav class="pc-sidebar">
      <div class="navbar-wrapper">
        <div class="m-header flex items-center py-4 px-6 h-header-height">
          <a href="../dashboard/index.html" class="b-brand flex items-center gap-3"> Forever_Perfume_AdminPanel
        ...
        <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
          <ul class="pc-navbar">
            ...
            <li class="pc-item pc-hasmenu">
              <a href="adduser.php" class="pc-link">
                <span class="pc-micon"> <i data-feather="user-plus"></i></span>
                <span class="pc-mtext">Add User</span>
              </a>
            </li>
            <li class="pc-item pc-hasmenu">
              <a href="order.php" class="pc-link">
            ...
            <li class="pc-item pc-hasmenu">
              <a href="login.php" class="pc-link" target="_blank">
                <span class="pc-micon"> <i data-feather="lock"></i></span>
                <span class="pc-mtext">Logout</span>
              </a>
            </li>
            <!--<li class="pc-item pc-hasmenu">
              <a href="register.php" class="pc-link" target="_blank">
                <span class="pc-micon"> <i data-feather="user-plus"></i></span>
